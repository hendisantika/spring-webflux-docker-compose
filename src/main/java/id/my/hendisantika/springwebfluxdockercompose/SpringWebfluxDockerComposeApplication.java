package id.my.hendisantika.springwebfluxdockercompose;

import id.my.hendisantika.springwebfluxdockercompose.book.Book;
import id.my.hendisantika.springwebfluxdockercompose.book.BookRepository;
...
public class SpringWebfluxDockerComposeApplication {

    public static void main(String[] args) {
        SpringApplication.run(SpringWebfluxDockerComposeApplication.class, args);
    }
